...
| Slice | Wave | Delivers |
|-------|------|----------|
| **NNNa** | N | Minimal shippable subset |
| **NNN (full)** | N+ | All acceptance criteria + success metric |

**Dependencies (hard)**:  
[List slice-specific blockers, e.g., "**064a:** STORY-002, STORY-015"]

**Dependencies (soft)**:  
[Full Definition of Done items that may land in a later wave]
