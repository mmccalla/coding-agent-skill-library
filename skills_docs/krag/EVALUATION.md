...
Roadmap and open work: `STATUS.md`. Release gates: `CONTRACTS.md` § Evaluation.
...
| Fixture | Cases | Used by | Purpose |
| --- | ---: | --- | --- |
| `tests/fixtures/retrieval_evaluation/golden_queries.json` | 1,194 | `evaluate_skill_retrieval.py`, e2e runner | Full regression corpus |
| `tests/fixtures/retrieval_evaluation/realistic_queries.json` | 8 | `test_e2e_realistic_retrieval.py` | Hand-curated confusers |
| `tests/fixtures/retrieval_evaluation/smoke_queries.json` | 6 | `ci_local.sh` cutover + eval | Fast CI smoke |
| `tests/fixtures/retrieval_evaluation/smoke_queries_promoted.json` | 6 | `ci_ingest_gate.py`, cutover default | Promoted-only ingest gate |
| `tests/fixtures/agent_journeys.json` | 7 | `test_agent_journeys.py` | MCP journey fixtures |
