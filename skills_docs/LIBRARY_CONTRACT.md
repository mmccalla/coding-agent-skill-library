...
With all category groupings installed (including enterprise-integration-patterns, solution-and-platform-architecture and krag-systems), the library contains **111** skills, including the mandatory `apply-laws-of-ai` baseline.
