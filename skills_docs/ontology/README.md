...
Primary-source URLs in skill `## References` sections are extracted into graph records as `standardsReferences` / reference documents. Content-level enforcement lives in `scripts/validate_skill_practice.py`.
