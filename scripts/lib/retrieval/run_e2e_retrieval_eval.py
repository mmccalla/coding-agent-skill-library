...
def run_realistic_e2e(
    *,
    ...
    """Run release, full-corpus, realistic-confuser and promoted-smoke evaluation arms."""
    ...
    payload: dict[str, object] = {
        ...
        "smoke_promoted_passed": smoke_report.passed,
        "smoke_promoted_evaluation": smoke_report.model_dump(),
    }
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print(f"Promoted smoke eval: {'PASS' if report['smoke_promoted_passed'] else 'FAIL'}")
    return 0
