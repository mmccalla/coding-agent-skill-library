...
from scripts.graph.build.build_retrieval_projections import build_retrieval_projection_records
from scripts.graph.build.extract_skills_graph import extract_skills_graph_records
from scripts.lib.config.repo_paths import REPO_ROOT
from scripts.lib.config.skills_config import Neo4jSettings, load_settings
from scripts.runtime.mcp import skills_mcp_perf
from scripts.validators.validate_skills_graph import validate_graph_records
...
def _retrieval_unit_from_section(
    ...
    return _node(
        ...
        unit_id,
        {
            ...
            "heading_path": _string(section, "heading_path"),
