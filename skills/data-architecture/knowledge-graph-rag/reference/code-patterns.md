...
Detailed code and query patterns for `knowledge-graph-rag/SKILL.md`. Load this file when generating or reviewing KG-RAG schemas, persistence, retrieval or evaluator code.
