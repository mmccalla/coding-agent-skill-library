...
Detailed execution guidance for `knowledge-graph-rag/SKILL.md`. Load this file when implementation, architecture alignment, invariants, lifecycle steps, security guardrails or done criteria are needed.
