# Data Architecture Skills Manifest

Use these skills for DAMA-DMBOK2-aligned and CDMC-aware data architecture.
...
| `data-governance-and-quality` | Defining ownership, policy, quality rules, controls, monitoring and remediation. |
| `data-security-and-privacy-architecture` | Designing classification, access, masking, privacy and entitlement controls. |
| `data-lifecycle-and-retention-management` | Designing retention, archival, deletion, legal hold and lifecycle controls. |
