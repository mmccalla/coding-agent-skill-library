...
Detailed execution guidance for `kg-enabled-rag/SKILL.md`. Load this file when implementation, architecture alignment, invariants, lifecycle steps, security guardrails or done criteria are needed.
