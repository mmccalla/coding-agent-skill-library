...
## Procedure
1. Identify domain, critical data and consumers.
2. Assign owner, steward and decision rights.
3. Define policies and standards.
4. Define quality dimensions/rules.
5. Define thresholds and severity.
6. Define validation and monitoring.
7. Define issue/remediation workflow.
