...
SMOKE_DATASET = Path("tests/fixtures/retrieval_evaluation/smoke_queries_promoted.json")
...
class KragCutoverAcceptanceTests(unittest.TestCase):
    def test_cutover_acceptance_report_passes_for_smoke_dataset(self) -> None:
        ...
        self.assertEqual("skill:tdd-practice", recommendation.selected_skill_id)
