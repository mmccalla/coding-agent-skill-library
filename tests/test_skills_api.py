...
"""
    ...
    def test_query_endpoint_routes_direct_skill_lookup_before_generation(self) -> None:
        ...
        self.assertIn("heading_path", evidence["skill"]["retrieval_units"][0])
        self.assertIn("line_start", evidence["skill"]["retrieval_units"][0])
        self.assertIn("line_end", evidence["skill"]["retrieval_units"][0])
